    ...
    <div class="col-8 mx-auto">
        <div class="card shadow">
            <div class="card-body">
                ...
                <form method="post" action="{{ route('update.correspondant') }}" class="needs-validation p-3" novalidate>
                    @csrf
                    <input type="hidden" name="id" value="{{ $row->id }}">
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom02">Nom</label>
                            <input type="text" class="form-control" id="validationCustom02" value="{{ $row->nom }}" name="nom"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control" value="{{ $row->email }}" id="validationCustom02" name="email"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $row->phone }}" id="validationCustom02" name="phone"
                                placeholder="Entrez le contact du correspondant">
                            <div class="valid-feedback"></div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="validationCustom02">Fonction/Profession</label>
                            <input type="text" class="form-control" value="{{ $row->fonction }}" id="validationCustom02" name="fonction"
