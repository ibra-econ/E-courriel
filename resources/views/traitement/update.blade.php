...
<div class="stepper-wrapper pt-3">
    ...
    <div class="stepper-item {{ $imputation->courrier->etat === "Imputer" || "Enregistré" ? 'completed' : '' }}">
        <div class="step-counter"><i class="{{ $imputation->courrier->etat === " Imputer" || "Enregistré"
                ? 'fe fe-check' : '' }}"></i>
        </div>
        <div class="step-name">Imputer</div>
    </div>
    <div class="stepper-item">
        <div class="step-counter {{ $imputation->courrier->etat === "Traiter" ? 'completed' : '' }}"><i
                class="{{ $imputation->courrier->etat === "Traiter" ? 'fe fe-check' : '' }}"></i></div>
        <div class="step-name">Valider</div>
    </div>
    <div class="stepper-item">
        <div class="step-counter {{ $imputation->courrier->etat === "Archiver" ? 'completed' : '' }}">
            <i class="{{ $imputation->courrier->etat === "Archiver" || "Enregistré" || "Imputer" || "Traiter"
                ? 'fe fe-check' : '' }}"></i>
        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="card text-center mb-2 shadow">
                                                ...
                                                <div class="card-footer bg-transparent border-0 fname">
                                                    ...
                                                    <strong>crée: {{ date('d/m/Y',strtotime($row->created_at))
                                                        }}</strong>
                                                </div> <!-- .card-footer -->
                                            </div> <!-- .card -->
                                        </div>
                                ...
                                <div class="p-5" id="imputation">
                                    <div class="mb-5 row">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <p class="mb-2 text-dark font-weight-bolder text-uppercase">Diffusion(Pour
                                                avis):
    ...
    <div class="row  mx-auto">
        ...
        <div class="col-md-4 mx-auto mb-3">
            <div class="custom-control custom-switch">
                <input type="checkbox" name="valider" {{ $imputation->courrier->etat === "Traiter" ? 'checked' : '' }} class="custom-control-input" id="Valider">
