...
<div class="row">
    <div class="my-4 col-md-12">
        <div class="shadow card">
            <div class="card-body">
                <div class="toolbar">
                    <h5 class="card-title">Listes des courrier interne</h5>
                ...
                <form action="{{ route('new.courrier') }}" method="POST" class="p-3 needs-validation"
                    ...
                    <div class="form-row">
                        ...
                        <div class="mb-3 col-md-3">
                            ...
                            <input type="text" name="reference" value="{{ $numero == null ? 1 : 'CI-N°'.$numero->numero +1 }}/{{ Auth::user()->departement->code }}" class="form-control" id="validationCustom02"
