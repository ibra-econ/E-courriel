    ...
    <div class="col-md-12 my-4">
        <div class="shadow card">
            <div class="p-5 card-body">
                <div class="mb-5 row">
                    <div class="mb-4 text-center col-12">
                        <h3 class="mb-0 text-uppercase">
                            FICHE DE CIRCULATION COURRIER ARRIVEE N° {{ $courrier->numero }} <br>{{ $courrier->created_at->format('d/m/Y') }}</h3>
                    </div>
                    <div class="col-md-6">
                        ...
                        <p class="mb-2 text-dark font-weight-bolder text-uppercase">Origine: {{  $courrier->correspondant->prenom.' '. $courrier->correspondant->nom }}
                        </p>
                ...
                <p class="text-center mt-2">NB : Tout courrier reçu doit faire l’objet d’une ventilation dans les 24 heures
