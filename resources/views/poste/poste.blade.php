                ...
                <table class="table datatables" id="dataTable-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('edit.poste',['id'=> $row->id]) }}" role="button"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('new.poste') }}" method="POST" class="needs-validation p-3" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
...
<Script>
    ...
    swal.fire({
        title: "Supprimer?",
        icon: 'question',
        text: "Etes vous sur de vouloir supprimer cet poste!",
        type: "warning",
        showCancelButton: !0,
